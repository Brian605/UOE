            ...
            <div class="hero-static col-md-6 d-flex align-items-center bg-body-extra-light">
                <div class="p-3 w-100">
                    ...
                    <div class="mb-3 text-center">
                        <p class="text-uppercase fw-bold fs-sm text-muted">Set a new password</p>
                    </div>
                    <!-- END Header -->

                    <div class="row g-0 justify-content-center">
                        <div class="col-sm-8 col-xl-6">
                            <form class="js-validation-signin" action="/password/reset" method="POST">
                                @csrf
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="mb-4">
                                        <input type="password" class="form-control form-control-lg form-control-alt"
                                               required id="login-password" name="password_confirmation" placeholder="Confirm Password">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between">
                                            <a class="btn btn-sm btn-alt-secondary d-block d-lg-inline-block mb-1" href="/login">
                                                <i class="fa fa-sign-in opacity-50 me-1"></i> Log In
                                            </a>
