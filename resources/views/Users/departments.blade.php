...
@section('content')
    <div class="block block-rounded m-2">
        <div class="block-header">
            ...
            <button class="btn btn-primary block-options" type="button" data-bs-toggle="modal" data-bs-target="#newDepartment">New Department</button>
        </div>
        <hr class="separator">
              ...
              @foreach(\App\Models\Department::all() as $dept)
                  <tr>
                      ...
                      <td>
                          ...
                          <a href="/department/delete/{{$dept->id}}" class="btn btn-sm btn-danger m-2">Delete</a>
                ...
                <div class="modal-body">
                    <form method="post" action="/department/edit">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nameEdit" name="name" placeholder="e.g Finance,Research etc" class="form-control" required>
                        </div>
                        <div class="mb-4">
