...
@section('content')
    <div class="block block-rounded m-2">
        <div class="block-header">
            ...
            <button class="btn btn-primary block-options" type="button" data-bs-toggle="modal" data-bs-target="#newDepartment">New Livestock Category</button>
        </div>
        <hr class="separator">
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                ...
                <tbody>
                @php $c=1; @endphp
              @foreach(\App\Models\LivestockCategory::all() as $dept)
                  <tr>
                      <td>
                          {{$c}}
                      </td>
                      ...
                      <td>
                          ...
                          <a href="/livestock/category/delete/{{$dept->id}}" class="btn btn-sm btn-danger m-2">Delete</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/livestock/category/edit">
                        @csrf
    ...
    <div class="modal fade" id="newDepartment">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">New Livestock Category</h4>
                    <button class="btn btn-close" type="button" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form method="post" action="/livestock/category/new">
                        @csrf
                        <div class="mb-4">
                            <label class="form-label">Name</label>
