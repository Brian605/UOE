<head>
    ...
    <meta name="description" content="Bringing to life your dream farm.">

    <!-- ========== Page Title ========== -->
    <title>UOE Farm Management System</title>

    <!-- ========== Favicon Icon ========== -->
    <link rel="shortcut icon" href="https://www.uoeld.ac.ke/themes/uoeld/favicon.ico" type="image/x-icon">
